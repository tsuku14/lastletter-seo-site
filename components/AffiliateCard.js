...
// 承認済みプログラム: 不動産SHOPナカジツ(px.a8.net/svt/ejp?a8mat=4AZ8K7+CVSS42+5Q8Q+5YZ75, 16,000円/査定)
...
const affiliateData = {
  ...
  '不動産相続': {
    ...
    items: [
      {
        name: '不動産SHOPナカジツ 無料査定申込',
        description: '相続不動産の売却をプロがサポート。査定申込は無料・1分で完了（A8.net提携済・成果報酬16,000円）',
        url: 'https://px.a8.net/svt/ejp?a8mat=4AZ8K7+CVSS42+5Q8Q+5YZ75',
        badge: '無料査定',
        color: '#d97706',
      },
      {
