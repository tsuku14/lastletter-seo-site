...
const topics = [
  ...
  // 地域別相続情報（ローカルSEO高効果）
  { title: "東京都の相続税申告：地域別税理士の選び方", keywords: ["東京 相続税", "税理士 東京", "申告", "費用", "選び方"], category: "相続税", difficulty: "初級" },
  { title: "大阪府の相続手続き：司法書士・弁護士の探し方", keywords: ["大阪 相続", "司法書士 大阪", "弁護士", "費用", "探し方"], category: "相続手続き", difficulty: "初級" },
  { title: "名古屋の老人ホーム費用と施設選び", keywords: ["名古屋 老人ホーム", "費用", "施設選び", "特養", "介護"], category: "介護・福祉", difficulty: "初級" },
  { title: "神奈川県の相続登記：法務局の場所と手続き", keywords: ["神奈川 相続登記", "法務局", "手続き", "費用", "必要書類"], category: "相続手続き", difficulty: "初級" },
  { title: "福岡県の老人ホーム探し：費用相場と人気施設", keywords: ["福岡 老人ホーム", "費用", "施設", "特養", "介護付"], category: "介護・福祉", difficulty: "初級" },
  { title: "北海道での相続：雪国特有の不動産相続の注意点", keywords: ["北海道 相続", "不動産", "農地", "山林", "注意点"], category: "相続手続き", difficulty: "中級" },
  { title: "京都の葬儀・お墓：伝統的な葬儀と費用", keywords: ["京都 葬儀", "費用", "お墓", "寺院", "伝統"], category: "葬儀・お墓", difficulty: "初級" },
  { title: "沖縄の相続：門中・共有墓の法的問題と対処法", keywords: ["沖縄 相続", "門中", "共有墓", "土地", "法的問題"], category: "相続手続き", difficulty: "上級" },

  // 介護・福祉（詳細トピック）
  { title: "認知症の親の介護：家族が知っておくべき10のこと", keywords: ["認知症 介護", "家族", "10のこと", "準備", "対応"], category: "介護・福祉", difficulty: "初級" },
  { title: "介護離職を防ぐ働き方と制度活用ガイド", keywords: ["介護離職", "防ぐ", "介護休業", "制度", "仕事と介護"], category: "介護・福祉", difficulty: "初級" },
  { title: "在宅介護の限界サインと施設移行のタイミング", keywords: ["在宅介護 限界", "施設移行", "タイミング", "サイン", "判断"], category: "介護・福祉", difficulty: "中級" },
  { title: "要介護認定の申請から結果まで：スムーズに進める方法", keywords: ["要介護認定 申請", "流れ", "期間", "結果", "スムーズ"], category: "介護・福祉", difficulty: "初級" },
  { title: "高齢者の消費者被害・詐欺から守るための対策", keywords: ["高齢者 詐欺", "消費者被害", "振り込め詐欺", "対策", "家族"], category: "介護・福祉", difficulty: "初級" },
  { title: "老人ホームの入居拒否・退去リスクと対処法", keywords: ["老人ホーム 入居拒否", "退去", "リスク", "対処法", "規約"], category: "介護・福祉", difficulty: "中級" },
  { title: "特別養護老人ホームの入居待ちを短くする方法", keywords: ["特養 入居待ち", "短くする", "方法", "申請", "優先度"], category: "介護・福祉", difficulty: "中級" },
  { title: "介護施設のコロナ・感染症対策と面会制限の実態", keywords: ["介護施設 感染症", "コロナ", "面会制限", "対策", "実態"], category: "介護・福祉", difficulty: "初級" },
  { title: "親の介護費用を兄弟姉妹で分担する方法", keywords: ["介護費用 分担", "兄弟", "姉妹", "分け方", "トラブル"], category: "介護・福祉", difficulty: "中級" },
  { title: "介護ロボット・AIで変わる介護の未来", keywords: ["介護ロボット", "AI 介護", "未来", "テクノロジー", "負担軽減"], category: "介護・福祉", difficulty: "初級" },
  { title: "高齢者の運転免許返納：手続きと代替交通手段", keywords: ["運転免許 返納", "高齢者", "手続き", "代替交通", "特典"], category: "介護・福祉", difficulty: "初級" },

  // 葬儀・お墓（詳細トピック）
  { title: "樹木葬の選び方・費用・人気霊園ランキング", keywords: ["樹木葬", "選び方", "費用", "人気霊園", "自然葬"], category: "葬儀・お墓", difficulty: "初級" },
  { title: "永代供養墓の種類と費用：継承者なしでも安心", keywords: ["永代供養墓", "種類", "費用", "継承者なし", "選び方"], category: "葬儀・お墓", difficulty: "初級" },
  { title: "散骨（海洋散骨・山散骨）の法律と手続き", keywords: ["散骨", "海洋散骨", "法律", "手続き", "費用"], category: "葬儀・お墓", difficulty: "初級" },
  { title: "お墓の引っ越し（改葬・墓じまい）の手続きと費用", keywords: ["墓じまい", "改葬", "手続き", "費用", "流れ"], category: "葬儀・お墓", difficulty: "中級" },
  { title: "葬儀での香典の相場と書き方・包み方マナー", keywords: ["香典 相場", "書き方", "包み方", "マナー", "金額"], category: "葬儀・お墓", difficulty: "初級" },
  { title: "喪主の挨拶文例と進め方マニュアル", keywords: ["喪主 挨拶", "文例", "進め方", "マニュアル", "葬儀"], category: "葬儀・お墓", difficulty: "初級" },
  { title: "家族葬の費用と会社・親戚への連絡マナー", keywords: ["家族葬 費用", "連絡", "マナー", "会社", "親戚"], category: "葬儀・お墓", difficulty: "初級" },
  { title: "納骨の時期・方法・費用：四十九日後の流れ", keywords: ["納骨", "時期", "方法", "費用", "四十九日"], category: "葬儀・お墓", difficulty: "初級" },
  { title: "お盆・お彼岸の法要マナーと費用", keywords: ["お盆 法要", "お彼岸", "マナー", "費用", "準備"], category: "葬儀・お墓", difficulty: "初級" },
  { title: "無縁墓・無縁仏を避けるための生前準備", keywords: ["無縁墓", "無縁仏", "避ける", "生前準備", "永代供養"], category: "葬儀・お墓", difficulty: "中級" },

  // 不動産相続（詳細トピック）
  { title: "実家を相続した後の選択肢：売却・賃貸・空き家管理", keywords: ["実家 相続", "売却", "賃貸", "空き家", "選択肢"], category: "相続手続き", difficulty: "中級" },
  { title: "相続した不動産をすぐに売却する場合の注意点", keywords: ["相続 不動産 売却", "注意点", "税金", "取得費", "タイミング"], category: "相続手続き", difficulty: "中級" },
  { title: "空き家特例（3,000万円控除）で相続不動産の税を減らす", keywords: ["空き家特例", "3000万円控除", "相続 不動産", "売却", "条件"], category: "相続税", difficulty: "中級" },
  { title: "相続土地国庫帰属制度：不要な土地を国に返す方法", keywords: ["相続土地国庫帰属制度", "不要な土地", "国に返す", "条件", "費用"], category: "相続手続き", difficulty: "中級" },
  { title: "マンション相続の手続きと管理組合への対応", keywords: ["マンション 相続", "管理組合", "手続き", "名義変更", "管理費"], category: "相続手続き", difficulty: "中級" },
  { title: "農地を相続したら農業委員会への届出が必要", keywords: ["農地 相続", "農業委員会", "届出", "手続き", "転用"], category: "相続手続き", difficulty: "中級" },

  // 生前贈与（詳細トピック）
  { title: "年間110万円の基礎控除を使った贈与の完全ガイド", keywords: ["贈与税 基礎控除", "110万円", "暦年贈与", "節税", "方法"], category: "相続税", difficulty: "初級" },
  { title: "教育資金の一括贈与：1,500万円非課税の使い方", keywords: ["教育資金 贈与", "1500万円", "非課税", "祖父母", "孫"], category: "相続税", difficulty: "中級" },
  { title: "結婚・子育て資金の一括贈与：1,000万円非課税制度", keywords: ["結婚 子育て 贈与", "1000万円", "非課税", "制度", "条件"], category: "相続税", difficulty: "中級" },
  { title: "相続時精算課税制度の2024年改正と活用法", keywords: ["相続時精算課税", "2024年改正", "110万円控除", "活用法", "メリット"], category: "相続税", difficulty: "中級" },
  { title: "贈与税の配偶者控除（おしどり贈与）とは？", keywords: ["贈与税 配偶者控除", "おしどり贈与", "2000万円", "居住用", "条件"], category: "相続税", difficulty: "中級" },
  { title: "孫への贈与で相続税を節税する方法と注意点", keywords: ["孫 贈与", "相続税 節税", "注意点", "方法", "贈与契約"], category: "相続税", difficulty: "中級" },

  // 信託制度（詳細トピック）
  { title: "家族信託の始め方：手続き・費用・専門家の選び方", keywords: ["家族信託 始め方", "手続き", "費用", "専門家", "流れ"], category: "信託制度", difficulty: "中級" },
  { title: "家族信託と成年後見制度の違い・どちらを選ぶか", keywords: ["家族信託", "成年後見制度", "違い", "どちらを選ぶ", "比較"], category: "信託制度", difficulty: "中級" },
  { title: "家族信託で認知症対策：財産管理の凍結を防ぐ", keywords: ["家族信託 認知症対策", "財産管理", "凍結", "防ぐ", "準備"], category: "信託制度", difficulty: "中級" },
  { title: "受益者連続型信託：二次相続まで管理する方法", keywords: ["受益者連続型信託", "二次相続", "管理", "後継者", "設計"], category: "信託制度", difficulty: "上級" },
  { title: "商事信託と民事信託の違い：銀行信託の使い方", keywords: ["商事信託", "民事信託", "違い", "銀行信託", "活用"], category: "信託制度", difficulty: "上級" },

  // 生前準備（詳細トピック）
  { title: "老後の住まい選択：自宅改修vs施設移住vs引っ越し", keywords: ["老後 住まい", "選択", "自宅改修", "施設", "引っ越し"], category: "生前準備", difficulty: "初級" },
  { title: "高齢者が家を売る前に知るべき10のこと", keywords: ["高齢者 家 売る", "注意点", "10のこと", "不動産", "売却"], category: "生前準備", difficulty: "初級" },
  { title: "老後のキャッシュフロー計算：いくら必要か", keywords: ["老後 キャッシュフロー", "計算", "必要な資金", "生活費", "シミュレーション"], category: "生前準備", difficulty: "中級" },
  { title: "終活をサポートする専門家の選び方と費用比較", keywords: ["終活 専門家", "選び方", "費用", "比較", "行政書士"], category: "生前準備", difficulty: "初級" },
  { title: "生前葬（いのちの記念日）とは？費用と開催方法", keywords: ["生前葬", "いのちの記念日", "費用", "開催方法", "感謝伝える"], category: "生前準備", difficulty: "初級" },
  { title: "老後の医療費：高額療養費制度の賢い使い方", keywords: ["老後 医療費", "高額療養費制度", "使い方", "上限額", "申請"], category: "生前準備", difficulty: "初級" },
  { title: "シニアの資産運用：リスクを抑えた投資方法", keywords: ["シニア 資産運用", "投資", "リスク", "方法", "老後資金"], category: "生前準備", difficulty: "中級" },
  { title: "後見人制度を利用した財産管理の実際", keywords: ["後見人制度", "財産管理", "実際", "申請", "費用"], category: "法的制度", difficulty: "中級" },

  // エンディングノート（詳細トピック）
  { title: "エンディングノートの始め方：何から書けばいい？", keywords: ["エンディングノート 始め方", "何から書く", "順番", "内容", "書き方"], category: "エンディングノート", difficulty: "初級" },
  { title: "エンディングノートに書く財産リストの作り方", keywords: ["エンディングノート 財産リスト", "作り方", "銀行", "保険", "不動産"], category: "エンディングノート", difficulty: "初級" },
  { title: "ペットのためのエンディングノート：飼い主の義務", keywords: ["ペット エンディングノート", "飼い主", "義務", "引き取り先", "ペット信託"], category: "エンディングノート", difficulty: "初級" },
  { title: "エンディングノートの保管場所と家族への伝え方", keywords: ["エンディングノート 保管場所", "伝え方", "家族", "安全", "場所"], category: "エンディングノート", difficulty: "初級" },

  // 法的制度（詳細トピック）
  { title: "任意後見制度の手続きと費用：認知症前に備える", keywords: ["任意後見制度", "手続き", "費用", "認知症前", "備える"], category: "法的制度", difficulty: "中級" },
  { title: "法定後見と任意後見の違い・メリット・デメリット", keywords: ["法定後見", "任意後見", "違い", "メリット", "デメリット"], category: "法的制度", difficulty: "中級" },
  { title: "死後事務委任契約：葬儀・行政手続きを任せる方法", keywords: ["死後事務委任契約", "葬儀", "行政手続き", "任せる", "方法"], category: "法的制度", difficulty: "中級" },
  { title: "尊厳死・事前指示書（リビングウィル）の作り方", keywords: ["尊厳死", "事前指示書", "リビングウィル", "作り方", "法的効力"], category: "法的制度", difficulty: "中級" },
  { title: "相続税の更正の請求：申告ミスを後から訂正する方法", keywords: ["相続税 更正の請求", "申告ミス", "訂正", "方法", "期限"], category: "法的制度", difficulty: "上級" },

  // 訃報・連絡（詳細トピック）
  { title: "訃報の連絡方法：電話・メール・SNSの使い分け", keywords: ["訃報 連絡方法", "電話", "メール", "SNS", "マナー"], category: "訃報・連絡", difficulty: "初級" },
  { title: "忌中・喪中の期間と行動マナー完全ガイド", keywords: ["忌中", "喪中", "期間", "マナー", "行動"], category: "訃報・連絡", difficulty: "初級" },
  { title: "喪中はがきの書き方と送る時期・範囲", keywords: ["喪中はがき", "書き方", "送る時期", "範囲", "文例"], category: "訃報・連絡", difficulty: "初級" },
  { title: "弔電の送り方と文例：葬儀に参列できない場合", keywords: ["弔電", "送り方", "文例", "葬儀", "参列できない"], category: "訃報・連絡", difficulty: "初級" },
  { title: "葬儀の欠席マナーと供花・弔問のタイミング", keywords: ["葬儀 欠席", "マナー", "供花", "弔問", "タイミング"], category: "訃報・連絡", difficulty: "初級" },
  { title: "四十九日法要の準備と費用・参列者への対応", keywords: ["四十九日", "法要", "準備", "費用", "参列者"], category: "訃報・連絡", difficulty: "初級" },
  { title: "一周忌・三回忌の準備と費用・お布施の相場", keywords: ["一周忌", "三回忌", "準備", "費用", "お布施"], category: "訃報・連絡", difficulty: "初級" },

  // デジタル終活（詳細トピック）
  { title: "パスワード管理アプリの選び方と終活での使い方", keywords: ["パスワード管理 アプリ", "終活", "選び方", "1Password", "Bitwarden"], category: "デジタル終活", difficulty: "初級" },
  { title: "YouTubeチャンネル・ブログの死後の扱いと継承方法", keywords: ["YouTube 死後", "ブログ 相続", "継承", "扱い", "SNS"], category: "デジタル終活", difficulty: "中級" },
  { title: "ネット銀行・PayPay残高の相続手続き", keywords: ["ネット銀行 相続", "PayPay", "残高", "手続き", "手順"], category: "デジタル終活", difficulty: "中級" },
  { title: "NFT・メタバース資産の相続：新しいデジタル財産", keywords: ["NFT 相続", "メタバース", "デジタル資産", "新しい", "対応"], category: "デジタル終活", difficulty: "上級" },
  { title: "Google・Appleの「遺産設定」を今すぐやるべき理由", keywords: ["Google 遺産設定", "Apple 遺産連絡先", "やるべき", "理由", "設定方法"], category: "デジタル終活", difficulty: "初級" },

  // 相続税（追加上級トピック）
  { title: "非上場株式の相続：純資産価額方式・類似業種比準方式", keywords: ["非上場株式 相続", "純資産価額方式", "類似業種比準方式", "評価", "節税"], category: "相続税", difficulty: "上級" },
  { title: "海外財産の相続税：外国にある不動産・口座の扱い", keywords: ["海外財産 相続税", "外国不動産", "海外口座", "扱い", "申告"], category: "相続税", difficulty: "上級" },
  { title: "相続税の税務調査：調査官が目をつけるポイント", keywords: ["相続税 税務調査", "調査官", "ポイント", "対策", "指摘事項"], category: "相続税", difficulty: "上級" },
  { title: "法人への遺贈と相続税：会社に財産を遺す方法", keywords: ["法人 遺贈", "相続税", "会社", "財産", "節税"], category: "相続税", difficulty: "上級" },
  { title: "相続税対策としての不動産活用：タワマン節税の実態", keywords: ["相続税対策 不動産", "タワマン節税", "実態", "リスク", "規制"], category: "相続税", difficulty: "上級" },

  // 相続手続き（追加トピック）
  { title: "相続放棄した後の責任：管理義務と第三者への影響", keywords: ["相続放棄 責任", "管理義務", "第三者", "影響", "2023年改正"], category: "相続手続き", difficulty: "中級" },
  { title: "相続人が認知症の場合の遺産分割：成年後見制度の活用", keywords: ["相続人 認知症", "遺産分割", "成年後見制度", "活用", "問題"], category: "相続手続き", difficulty: "上級" },
  { title: "海外在住の相続人がいる場合の手続き", keywords: ["海外在住 相続人", "手続き", "書類", "認証", "ハーグ条約"], category: "相続手続き", difficulty: "上級" },
  { title: "戸籍が取れない場合の相続手続き：廃棄・滅失の対処法", keywords: ["戸籍 取れない", "相続手続き", "廃棄", "滅失", "対処法"], category: "相続手続き", difficulty: "上級" },
  { title: "相続発生後に発覚した借金への対処法", keywords: ["相続 借金 発覚", "対処法", "相続放棄", "限定承認", "期限"], category: "相続手続き", difficulty: "中級" },
  { title: "準確定申告の手続き：故人の代わりに確定申告する", keywords: ["準確定申告", "手続き", "故人", "代わり", "期限"], category: "相続手続き", difficulty: "中級" },

  // 保険・税務（追加トピック）
  { title: "医療保険・がん保険は終活でどう見直すべきか", keywords: ["医療保険 終活", "がん保険", "見直し", "解約", "継続"], category: "保険・税務", difficulty: "初級" },
  { title: "個人年金保険で老後資金を準備する方法", keywords: ["個人年金保険", "老後資金", "準備", "利率", "選び方"], category: "保険・税務", difficulty: "初級" },
  { title: "介護保険料の計算と40歳からの天引き額", keywords: ["介護保険料", "計算", "40歳", "天引き", "金額"], category: "保険・税務", difficulty: "初級" },
  { title: "役員退職金と相続：会社経営者の相続税対策", keywords: ["役員退職金", "相続", "会社経営者", "相続税対策", "事業承継"], category: "保険・税務", difficulty: "上級" },
  { title: "相続した借家・アパートの税務処理と運用方法", keywords: ["相続 借家", "アパート", "税務処理", "運用", "賃貸収入"], category: "保険・税務", difficulty: "中級" },

  // 生前準備（新規テーマ）
  { title: "おひとりさまの終活：独身・子なしが備えるべき10のこと", keywords: ["おひとりさま 終活", "独身", "子なし", "備える", "10のこと"], category: "生前準備", difficulty: "初級" },
  { title: "夫婦で進める終活：二人でやるべきことリスト", keywords: ["夫婦 終活", "二人でやること", "リスト", "準備", "対話"], category: "生前準備", difficulty: "初級" },
  { title: "定年退職後の終活スタートガイド：60代からの準備", keywords: ["定年退職後 終活", "60代", "スタート", "準備", "ガイド"], category: "生前準備", difficulty: "初級" },
  { title: "終活で後悔しない遺品整理の進め方と業者選び", keywords: ["遺品整理 終活", "後悔しない", "業者選び", "費用", "流れ"], category: "生前準備", difficulty: "初級" },
  { title: "親に終活を勧める会話術：嫌がられない伝え方", keywords: ["親 終活 勧める", "会話術", "嫌がられない", "伝え方", "タイミング"], category: "生前準備", difficulty: "初級" },
  { title: "終活でやっておくべきお金の整理リスト", keywords: ["終活 お金 整理", "リスト", "口座", "保険", "資産"], category: "生前準備", difficulty: "初級" },

  // 相続手続き（新規ニッチトピック）
  { title: "相続した暗号資産（仮想通貨）の税申告方法", keywords: ["相続 暗号資産", "仮想通貨", "税申告", "ビットコイン", "評価額"], category: "相続手続き", difficulty: "上級" },
  { title: "ゴルフ会員権・リゾート会員権の相続手続き", keywords: ["ゴルフ会員権 相続", "リゾート会員権", "手続き", "評価", "名義変更"], category: "相続手続き", difficulty: "中級" },
  { title: "著作権・特許権の相続：知的財産を守る方法", keywords: ["著作権 相続", "特許権", "知的財産", "守る", "手続き"], category: "相続手続き", difficulty: "中級" },
  { title: "事業承継と相続：中小企業オーナーの引き継ぎ方法", keywords: ["事業承継", "相続", "中小企業", "オーナー", "引き継ぎ"], category: "相続手続き", difficulty: "上級" },
  { title: "相続後の確定申告：相続した不動産からの賃料収入", keywords: ["相続後 確定申告", "不動産", "賃料収入", "申告方法", "経費"], category: "相続手続き", difficulty: "中級" },

  // SEO需要の高いトレンドトピック
  { title: "2024年からの相続税・贈与税の改正ポイントまとめ", keywords: ["相続税 贈与税 改正", "2024年", "ポイント", "変更点", "対応"], category: "相続税", difficulty: "中級" },
  { title: "相続税の申告書の書き方：第1表から第15表まで", keywords: ["相続税 申告書 書き方", "第1表", "書き方", "記載方法", "提出"], category: "相続税", difficulty: "上級" },
  { title: "コンビニで取得できる相続に必要な書類一覧", keywords: ["コンビニ 住民票", "相続 書類", "マイナンバーカード", "コンビニ交付", "取得方法"], category: "相続手続き", difficulty: "初級" },
  { title: "マイナンバーカードを使った相続手続きの効率化", keywords: ["マイナンバーカード 相続", "効率化", "手続き", "デジタル", "活用"], category: "相続手続き", difficulty: "初級" },
  { title: "終活アプリのおすすめ比較：2026年版", keywords: ["終活アプリ", "おすすめ", "比較", "2026年", "機能"], category: "エンディングノート", difficulty: "初級" },
  { title: "親が亡くなった時の最初の24時間でやること", keywords: ["親 亡くなった", "最初の24時間", "やること", "手続き", "流れ"], category: "相続手続き", difficulty: "初級" },
  { title: "相続問題で弁護士に相談するタイミングと費用", keywords: ["相続 弁護士 相談", "タイミング", "費用", "選び方", "初回相談"], category: "相続手続き", difficulty: "初級" },
  { title: "相続税を払えない場合の対処法：延納・物納・借入", keywords: ["相続税 払えない", "延納", "物納", "対処法", "借入"], category: "相続税", difficulty: "中級" },

  // ── 不動産相続（20件）── /fudosan-souzoku LP サポート記事
  { title: "相続した実家の売却タイミングと税金の注意点", keywords: ["実家 相続 売却", "タイミング", "譲渡所得税", "3年以内", "節税"], category: "不動産相続", difficulty: "初級" },
  { title: "相続登記の義務化2024：期限・手続き・罰則の完全ガイド", keywords: ["相続登記 義務化", "2024年", "期限", "罰則", "手続き"], category: "不動産相続", difficulty: "初級" },
  { title: "相続した空き家の管理・売却・活用の選択肢を比較", keywords: ["空き家 相続", "管理", "売却", "活用", "選択肢"], category: "不動産相続", difficulty: "初級" },
  { title: "不動産を相続したら最初にやること10ステップ", keywords: ["不動産 相続 最初", "やること", "手順", "チェックリスト", "登記"], category: "不動産相続", difficulty: "初級" },
  { title: "相続不動産の査定方法と不動産会社の選び方", keywords: ["相続不動産 査定", "不動産会社", "選び方", "一括査定", "比較"], category: "不動産相続", difficulty: "初級" },
  { title: "空き家特例（3000万円控除）で相続不動産の税を大幅節税", keywords: ["空き家特例", "3000万円控除", "適用条件", "期限", "申告方法"], category: "不動産相続", difficulty: "中級" },
  { title: "相続した土地・建物を売却する際の税金計算方法", keywords: ["相続 土地 売却 税金", "譲渡所得", "取得費", "特別控除", "計算"], category: "不動産相続", difficulty: "中級" },
  { title: "相続した不動産を賃貸に出すメリット・デメリット", keywords: ["相続 不動産 賃貸", "メリット", "デメリット", "収益", "管理費"], category: "不動産相続", difficulty: "初級" },
  { title: "共有名義で相続した不動産のトラブルと解決策", keywords: ["共有名義 相続", "不動産 トラブル", "解決策", "持分", "売却"], category: "不動産相続", difficulty: "中級" },
  { title: "相続土地国庫帰属制度：不要な土地を国に返す手続き", keywords: ["相続土地国庫帰属制度", "不要な土地", "国に返す", "申請方法", "費用"], category: "不動産相続", difficulty: "中級" },
  { title: "相続不動産の名義変更を自分でする方法と費用", keywords: ["相続 名義変更 自分で", "法務局", "申請書", "費用", "必要書類"], category: "不動産相続", difficulty: "中級" },
  { title: "マンションを相続したら管理費・修繕積立金はどうなる？", keywords: ["マンション 相続", "管理費", "修繕積立金", "管理組合", "手続き"], category: "不動産相続", difficulty: "初級" },
  { title: "農地を相続した場合の手続きと農業委員会への届出", keywords: ["農地 相続", "農業委員会", "届出", "転用", "許可"], category: "不動産相続", difficulty: "中級" },
  { title: "相続した実家を解体して売却する手順と費用", keywords: ["実家 解体", "売却", "費用", "相場", "流れ"], category: "不動産相続", difficulty: "初級" },
  { title: "相続した土地の固定資産税を節税する方法", keywords: ["固定資産税 相続", "節税", "方法", "空き家 特例", "減免"], category: "不動産相続", difficulty: "中級" },
  { title: "相続放棄しても不動産の管理義務は残る？最新法改正の影響", keywords: ["相続放棄 管理義務", "不動産", "2023年改正", "影響", "対処法"], category: "不動産相続", difficulty: "中級" },
  { title: "相続した借地権・底地の処理方法と売却のポイント", keywords: ["借地権 相続", "底地", "処理", "売却", "評価方法"], category: "不動産相続", difficulty: "上級" },
  { title: "相続不動産を兄弟間で公平に分ける方法", keywords: ["相続不動産 兄弟", "公平に分ける", "代償分割", "換価分割", "トラブル防止"], category: "不動産相続", difficulty: "中級" },
  { title: "相続した不動産の測量・境界確認が必要なケース", keywords: ["相続 測量", "境界確認", "隣地", "費用", "トラブル防止"], category: "不動産相続", difficulty: "中級" },
  { title: "相続不動産の一括査定サービス比較：イエウール・HOME'S等", keywords: ["相続不動産 一括査定", "比較", "イエウール", "HOME'S", "選び方"], category: "不動産相続", difficulty: "初級" },

  // ── 家族信託（15件）── /kazoku-shintaku LP サポート記事
  { title: "家族信託とは？認知症対策・相続対策の新しい選択肢", keywords: ["家族信託 とは", "認知症対策", "相続対策", "仕組み", "わかりやすく"], category: "信託制度", difficulty: "初級" },
  { title: "家族信託の費用はいくら？公正証書から登記まで", keywords: ["家族信託 費用", "公正証書", "登記", "司法書士", "相場"], category: "信託制度", difficulty: "初級" },
  { title: "家族信託で認知症になっても財産が凍結されない理由", keywords: ["家族信託 認知症", "財産凍結", "防ぐ", "口座 凍結", "メリット"], category: "信託制度", difficulty: "初級" },
  { title: "家族信託と成年後見制度どちらを選ぶ？違いを比較", keywords: ["家族信託 成年後見", "比較", "どちらを選ぶ", "メリット デメリット", "費用"], category: "信託制度", difficulty: "初級" },
  { title: "家族信託の委託者・受託者・受益者の役割を解説", keywords: ["家族信託 委託者", "受託者", "受益者", "役割", "関係性"], category: "信託制度", difficulty: "初級" },
  { title: "不動産の家族信託：アパート管理・資産承継への活用", keywords: ["不動産 家族信託", "アパート管理", "収益物件", "承継", "活用法"], category: "信託制度", difficulty: "中級" },
  { title: "家族信託の設定手続き：公証役場から登記まで全手順", keywords: ["家族信託 設定 手続き", "公証役場", "登記", "手順", "流れ"], category: "信託制度", difficulty: "中級" },
  { title: "家族信託の信託財産にできるもの・できないもの", keywords: ["家族信託 信託財産", "できるもの", "できないもの", "年金", "範囲"], category: "信託制度", difficulty: "中級" },
  { title: "家族信託の終了条件と信託財産の帰属先の決め方", keywords: ["家族信託 終了", "信託財産 帰属", "条件", "受益者 死亡", "設計"], category: "信託制度", difficulty: "中級" },
  { title: "家族信託で失敗しないための注意点と専門家の選び方", keywords: ["家族信託 失敗", "注意点", "専門家", "選び方", "トラブル"], category: "信託制度", difficulty: "初級" },
];
...
【記事の流れ例】
1. タイトル（#）の直後に「この記事でわかること」ボックスを必ず配置（AI検索エンジン対策・必須）
2. 導入（読者の悩みに共感）
3. 基本的な定義・概要
4. 法的根拠・制度の説明
5. 具体的な手順・方法
...
■ 「この記事でわかること」ボックス（Perplexity・ChatGPT引用対策・必須）
タイトル（# ...）の直後、本文の先頭に**必ず**以下の形式で配置してください。
AIが回答生成時に引用しやすい構造にするため、具体的な数値・期限・結論を含めてください。

\`\`\`
## この記事でわかること
- [具体的な数値や結論を含むポイント1（例: 相続税の基礎控除は3,000万円＋600万円×法定相続人数）]
- [ポイント2（例: 申告期限は相続発生から10ヶ月以内）]
- [ポイント3（例: 節税方法：生命保険・小規模宅地等の特例・生前贈与）]
\`\`\`
